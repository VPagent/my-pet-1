...
const ItemCard:React.FC<Props> = ({item, styles, handleClick, handleClickOnCard, backButton}:Props):JSX.Element => {
    ...
    return(
        <Card sx={styles.cardStyle}  onClick={(event) => {handleClickOnCard && handleClickOnCard(event, id)}} >
